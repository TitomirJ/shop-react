...
import {fetchPhones, editPhoneId, deletePhone} from 'actions';
    ...
    renderPhone = (phone, index) => {
        return (
            ...
            >
                ...
                <td>
                    <Button onClick={() => this.deletePhone(phone.id)} className='d-inline-flex align-items-center' type='danger'>
                        delete
                        <DeleteOutlined/>
                    </Button>
                </td>
